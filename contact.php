...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Jaypee University Of Engineering and Technology<br>Guna, India 473226<br>
                </p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E-mail:</abbr>: <a href="mailto:191b093@juetguna.in">191b093@juetguna.in</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">Time</abbr>: Monday - Sunday: 9:00 AM to 9:00 PM</p>
